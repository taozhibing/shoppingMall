...
export default {
  ...
  // 增加收货地址(22)
  address({ name, tel, address, isDefault, province, city, county, addressDetail, areaCode, _id }) {
    return service.post(`/address`, { name, tel, address, isDefault, province, city, county, addressDetail, areaCode, _id })
  },
  // 删除地址(23)
  deleteAddress({ id }) {
