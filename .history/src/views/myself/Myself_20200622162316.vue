      ...
      <div class="content">
        ...
        <div class="box">
          <div class="img">
            ...
            <div class="icn" @click="profile"><van-icon name="setting-o" size="20"/></div>
          </div>
          <div class="text" v-if="flag">欢迎您 ： {{userInfo.nickname}}</div>
          <div class="text" v-else></div> 
          <div class="text" @click="logout" v-if="flag">退出登录</div>
          <div class="text" @click="login" v-else>登录/注册</div>
        </div>
      </div>
      <div class="tabbars">
        <div>
